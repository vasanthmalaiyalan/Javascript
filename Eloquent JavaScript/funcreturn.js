...
console.log(Math.min(2,4));//value produce+return and js rule also apply function call(produce) and return => expression
console.log(Math.min(2,4)+100);//🧾 Expression inside expression
